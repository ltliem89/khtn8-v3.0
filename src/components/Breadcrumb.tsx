...
export const Breadcrumb: React.FC = () => {
  ...
  return (
    <div className="bg-slate-50/80 border-b border-slate-200/60 py-2.5 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto flex items-center justify-between text-xs text-slate-500">
        ...
        {(context.returnTo || historyStack.length > 0) && (
          <button
            type="button"
            onClick={goBack}
            className="flex items-center gap-1 px-2.5 py-1 text-xs font-medium text-slate-700 bg-white border border-slate-200 rounded-md hover:bg-slate-100 transition-colors cursor-pointer shadow-2xs"
          >
